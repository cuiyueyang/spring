...
public class StringBuilderHolder {
     ...
     */
    private static final ThreadLocal<StringBuilder> globalStringBuilder = ThreadLocal.withInitial(()->new StringBuilder(512));

    /**
     * 独立创建的ThreadLocal的StringBuilder
     */
    private final ThreadLocal<StringBuilder> stringBuilder = new ThreadLocal<StringBuilder>() {
        @Override
