package com.example.demo.linkUtils.reflect;

import com.example.demo.linkUtils.base.ExceptionUtil;
import com.example.demo.linkUtils.base.ObjectUtil;
import com.example.demo.linkUtils.base.type.UncheckedException;
...
public class ReflectionUtil {
     ...
     * 性能较差, 用于单次调用的场景
     */
    public static <T> T getProperty(Object obj, String propertyName) throws NoSuchFieldException {
        Method method = getGetterMethod(obj.getClass(), propertyName);
        if (method != null) {
            return invokeMethod(obj, method);
        } else {
     ...
     * 性能较差, 用于单次调用的场景
     */
    public static void setProperty(Object obj, String propertyName, final Object value) throws NoSuchFieldException {
        Method method = getSetterMethod(obj.getClass(), propertyName, value.getClass());
        if (method != null) {
            invokeMethod(obj, method, value);
        } else {
