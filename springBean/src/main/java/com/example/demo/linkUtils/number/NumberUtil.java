...
public class NumberUtil {
     ...
     * 当str为空或非数字字符串时抛NumberFormatException
     */
    public static Double toDoubleObject(@Nullable String str) {
        // 统一行为，不要有时候抛NPE，有时候抛NumberFormatException
        if (str == null) {
            throw new NumberFormatException("null");
        }
     ...
     * 当str为空或非数字字符串时抛NumberFormatException
     */
    public static Integer hexToIntObject(@Nullable String str) {
        // 统一行为，不要有时候抛NPE，有时候抛NumberFormatException
        if (str == null) {
            throw new NumberFormatException("null");
        }
     ...
     * 当str为空或非数字字符串时抛NumberFormatException
     */
    public static Long hexToLongObject(@Nullable String str) {
        // 统一行为，不要有时候抛NPE，有时候抛NumberFormatException
        if (str == null) {
            throw new NumberFormatException("null");
        }
    ...
    public static String toString(@NonNull Integer i) {
        return i.toString();
    }
