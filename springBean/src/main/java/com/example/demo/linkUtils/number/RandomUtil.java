...
import com.example.demo.linkUtils.base.MoreValidate;
...
public class RandomUtil {
    ...
    private static final String ARG_RANGE_ERROR = "Start value must be smaller or equal to end value.";
...
////////////////// nextInt 相关/////////
    ...
    public static int nextInt(Random random, int min, int max) {
        Validate.isTrue(max >= min, ARG_RANGE_ERROR);
