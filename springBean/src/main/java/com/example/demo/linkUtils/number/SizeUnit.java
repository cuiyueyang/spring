package com.example.demo.linkUtils.number;
 ...
 * Usage example:
 *
 * assertTrue(SizeUnit.BYTES.toMegaBytes(1024 * 1024) == 1.0);
 *
...
public enum SizeUnit {
    ...
    private static final double KILOBYTES_PER_MEGABYTE = 1024.0;
    /** Number of megabytes per gigabyte. */
    private static final double MEGABYTES_PER_GIGABYTE = 1024.0;
    private static final String WONT_THROW = "the value can't be recognized for enum MemoryUnit.";
    ...
    public double toBytes(final long input) {
        ...
        switch (this) {
            ...
            case GIGABYTES:
                ...
                break;
            default:
                throw new RuntimeException(WONT_THROW);
        }
        return bytes;
    }
