...
public class BeanMapper {
     ...
     * 简单的列表拷贝方法
     */
    public static <S, D> void copyList(Iterable<S> sourceList, Collection<D> destination, Class<D> destinationClass) {
        mapper.mapAsCollection(sourceList, destination, destinationClass);
    }
