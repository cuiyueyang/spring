...
import com.example.demo.linkUtils.collection.type.ConcurrentHashSet;
...
public class SetUtil {
    ...
    public static <T extends Comparable> SortedSet<T> newSortedSet() {
        return new TreeSet<>();
    }
     ...
     */
    public static <T> SortedSet<T> newSortedSet(@NonNull Comparator<? super T> comparator) {
