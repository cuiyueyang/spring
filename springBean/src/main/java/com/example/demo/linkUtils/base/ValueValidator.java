...
public class ValueValidator {
    ...
    public interface Validator<T> {
         ...
         */
        Validator<Integer> INTEGER_GT_ZERO_VALIDATOR = (Integer value) -> value != null && value > 0;

        /**
         * 校验器: 字符串不为空串较验
         */
        Validator<String> STRING_EMPTY_VALUE_VALIDATOR = StringUtils::isNotEmpty;

        /**
         * 校验器: BOOL字符串较验
         */
        Validator<String> STRICT_BOOL_VALUE_VALIDATOR = (String value) -> "true".equalsIgnoreCase(value) || "false".equalsIgnoreCase(value);
