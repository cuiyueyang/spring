...
public class MapUtil {
     ...
     */
    public static <K, V> V putIfAbsentReturnLast(@NonNull final ConcurrentMap<K, V> map, final K key, final V value) {
     ...
     */
    public static <K, V> V createIfAbsentReturnLast(@NonNull final ConcurrentMap<K, V> map, final K key,
                                                    @NonNull final ValueCreator<? extends V> creator) {
     ...
     * 同时初始化元素.
     */
    public static <K, V> HashMap<K, V> newHashMap(@NonNull final List<K> keys, @NonNull final List<V> values) {
     ...
     */
    public static <K extends Enum<K>, V> EnumMap<K, V> newEnumMap(@NonNull Class<K> type) {
