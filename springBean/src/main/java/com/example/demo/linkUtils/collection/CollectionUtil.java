...
import com.example.demo.linkUtils.base.type.Pair;
...
public class CollectionUtil {
     ...
     *
     * @param collection 传入的collection集合
     * @return 返回单一模板对象
     */
     ...
     * 两个集合中的所有元素按顺序相等.
     *
     * @param iterable1 需要进行比较的集合1
     * @param iterable2 需要进行比较的集合2
     * @return 返回boolean值
     */
