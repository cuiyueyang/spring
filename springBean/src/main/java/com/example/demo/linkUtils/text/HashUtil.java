 ...
 * @see cn.hutool.crypto.SecureUtil
 */
public class HashUtil {
    ...
    public static void unloadMd5() {
        MD5_DIGEST.remove(); // Compliant
    }

    public static void unloadSha1() {
        SHA_1_DIGEST.remove(); // Compliant
    }
     ...
     */
    public static byte[] sha1(@NonNull String input) {
     ...
     */
    public static byte[] sha1(@NonNull byte[] input, @Nullable byte[] salt) {
     ...
     * 对输入字符串进行sha1散列，带salt达到更高的安全性.
     */
    public static byte[] sha1(@NonNull String input, @Nullable byte[] salt) {
     ...
     */
    public static byte[] sha1(@NonNull byte[] input, @Nullable byte[] salt, int iterations) {
     ...
     * @see #generateSalt(int)
     */
    public static byte[] sha1(@NonNull String input, @Nullable byte[] salt, int iterations) {
    ...
    /**
     * 对输入字符串进行md5散列, 编码默认为UTF8.
     */
    public static byte[] md5(@NonNull String input) {
        return digest(input.getBytes(Charsets.UTF_8), get(MD5_DIGEST), null, 1);
    }

    /**
     * 对输入字符串进行md5散列，带salt达到更高的安全性.
     */
    public static byte[] md5(@NonNull byte[] input, @Nullable byte[] salt) {
        return digest(input, get(MD5_DIGEST), salt, 1);
    }

    /**
     * 对输入字符串进行md5散列，带salt达到更高的安全性.
     */
    public static byte[] md5(@NonNull String input, @Nullable byte[] salt) {
     ...
     * @see #generateSalt(int)
     */
    public static byte[] md5(@NonNull byte[] input, @Nullable byte[] salt, int iterations) {
        return digest(input, get(MD5_DIGEST), salt, iterations);
    }
     ...
     * @see #generateSalt(int)
     */
    public static byte[] md5(@NonNull String input, @Nullable byte[] salt, int iterations) {
        return digest(input.getBytes(Charsets.UTF_8), get(MD5_DIGEST), salt, iterations);
    }
     ...
     */
    public static int crc32AsInt(@NonNull String input) {
     ...
     * Guava也有crc32实现, 但返回值无法返回long，所以统一使用JDK默认实现
     */
    public static int crc32AsInt(@NonNull byte[] input) {
     ...
     * Guava也有crc32实现, 但返回值无法返回long，所以统一使用JDK默认实现
     */
    public static long crc32AsLong(@NonNull String input) {
     ...
     * Guava也有crc32实现, 但返回值无法返回long，所以统一使用JDK默认实现
     */
    public static long crc32AsLong(@NonNull byte[] input) {
        CRC32 crc32 = new CRC32();
        crc32.update(input);
     ...
     */
    public static int murmur32AsInt(@NonNull byte[] input) {
     ...
     * 对输入字符串进行murmur32散列, 返回值可能是负数
     */
    public static int murmur32AsInt(@NonNull String input) {
     ...
     */
    public static long murmur128AsLong(@NonNull byte[] input) {
     ...
     * 对输入字符串进行murmur128散列, 返回值可能是负数
     */
    public static long murmur128AsLong(@NonNull String input) {
